...
# has a revision number of 3 and 4 for its first and second level revision number. Its third and fourth level revision number are both 0.
...
class TestSimpleNumber < Test::Unit::TestCase
  def test_simple
    assert_equal(-1, compare_version('0.1','1.1'))
    assert_equal(1, compare_version('1.0.1','1'))
    assert_equal(-1, compare_version('7.5.2.4','7.5.3'))
    assert_equal(0, compare_version('1.01','1.001'))
    assert_equal(0, compare_version('1.0','1.0.0'))
  end 
end