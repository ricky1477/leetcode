...
def longest_substring(s)
  ...
  puts
  puts "#{s} | #{substrings.inspect}"
  return substrings.max_by(&:length).length
end
...
#longest_substring($rly_long_str)

class TestSimpleNumber < Test::Unit::TestCase
  def test_simple
    assert_equal(3, longest_substring('abcabcbb'))
    assert_equal(1, longest_substring('bbbbb'))
    assert_equal(3, longest_substring('pwwkew'))
    assert_equal(9, longest_substring('rickdabosric'))
    assert_equal(0, longest_substring(''))
    assert_equal(1, longest_substring(' '))
    assert_equal(3, longest_substring('dvdf'))
    assert_equal(5, longest_substring('anviaj'))
    assert_equal(6, longest_substring('asjrgapa'))
    assert_equal(96, longest_substring($rly_long_str))
  end 
end