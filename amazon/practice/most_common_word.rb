...
def most_common_word(paragraph, banned)
  counts = Hash.new 0
  arr = paragraph.downcase.gsub(/[!?';.]/, '').split(/[\s,]+/)
  #p arr
  arr.each do |word|
    counts[word] += 1
  end
  counts.delete_if{|key| banned.include?(key)}
  # find the key of the largest hash value
...
class TestSimpleNumber < Test::Unit::TestCase
  def test_simple
    ...
    assert_equal('b', most_common_word("a, a, a, a, b,b,b,c, c", ["a"]))
  end 
end
