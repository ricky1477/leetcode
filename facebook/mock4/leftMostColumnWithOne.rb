...
# BinaryMatrix.dimensions() returns a list of 2 elements [rows, cols], which means the matrix 
# is rows * cols.
...
def leftMostColumnWithOne(binaryMatrix)
  ...
  binaryMatrix.each_with_index do |arr, i|
...
def binary_search(nums, target)
  ...
  # Not found so return a high number
  return (2**31)
end